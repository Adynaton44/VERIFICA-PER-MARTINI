...
public class DialogoStudente extends JDialog implements ActionListener{
	...
	public DialogoStudente(Finestra f,boolean modal) {
		super(f,modal);
		initCC();
	...
	public void initCC() {
		...
		l7=new JLabel("inserire classe");
		l8=new JLabel("inserire sezione");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(salva)) {
			...
			try {
				s=new Studente(t1.getText(),t2.getText(),t3.getText(),c,Integer.parseInt(t7.getText()),t8.getText());
	...
	public Studente ritornaStudente() {
		return s;
	}
